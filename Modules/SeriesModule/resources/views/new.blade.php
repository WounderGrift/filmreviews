...
@section('content')
    ...
    <div id="loading-model" class="info-block" style="display: none;">
        <div class="info_title"><b>Данные были загружены из хранилища (saveNewSeries)</b></div>
                    ...
                    <div class="blog-info-text">
                        <div class="col-12 order-2">
                            <div class="poster-box summary-block"
                                 style="background: rgba(251, 251, 251, 0.9); display: flex; flex-direction: column;">
                                <div>
